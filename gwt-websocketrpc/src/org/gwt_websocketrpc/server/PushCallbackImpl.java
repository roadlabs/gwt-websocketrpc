...
class PushCallbackImpl implements PushCallback {
    private final Outbound out;
    private final int requestid;
    private final ClientOracle oracle;
    private final Method requestMethod;

    public PushCallbackImpl(ClientOracle oracle, Method requestMethod,
            Outbound o, int rid) {
        this.oracle = oracle;
    ...
    public void call(Object responseObject) throws SerializationException,
        ...
        if (responseObject == null) {
            ...
            os.write((Integer.toHexString(requestid) + WsRpcControlString)
                    .getBytes());
